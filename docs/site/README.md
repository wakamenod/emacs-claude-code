...
- **Take the scenes in small batches, and look at the echo area of what comes
  ...
  while the same scenes taken one at a time came out clean (2026-09-12).  That
  error is a real one, in the debounced redraw, and it is not understood yet;
  it has only ever shown up in a long run.
