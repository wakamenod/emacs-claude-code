...
- `scripts/` — the recorders that make the fixtures, and `screenshot.sh`,
  which regenerates `docs/images/session.png` by replaying two fixtures into a
  throwaway GUI frame. macOS only, and the terminal needs Screen Recording
  permission.
